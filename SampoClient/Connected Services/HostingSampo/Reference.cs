...
namespace SampoClient.HostingSampo {
    ...
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(SampoClient.HostingSampo.Sampo))]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(SampoClient.HostingSampo.Partner))]
    ...
    [System.SerializableAttribute()]
    public partial class Sampo : SampoClient.HostingSampo.BaseVM {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private SampoClient.HostingSampo.Partner[] FollowersField;
        
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private SampoClient.HostingSampo.Partner[] LidersField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public SampoClient.HostingSampo.Partner[] Followers {
            get {
        ...
        [System.Runtime.Serialization.DataMemberAttribute()]
        public SampoClient.HostingSampo.Partner[] Liders {
            get {
    ...
    public interface IForOrganizators {
        ...
        SampoClient.HostingSampo.AuthorizationWithLoginResponse AuthorizationWithLogin(SampoClient.HostingSampo.AuthorizationWithLoginRequest request);
        
        // CODEGEN: Идет формирование контракта на сообщение, так как операция может иметь много возвращаемых значений.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IForOrganizators/AuthorizationWithLogin", ReplyAction="http://tempuri.org/IForOrganizators/AuthorizationWithLoginResponse")]
        System.Threading.Tasks.Task<SampoClient.HostingSampo.AuthorizationWithLoginResponse> AuthorizationWithLoginAsync(SampoClient.HostingSampo.AuthorizationWithLoginRequest request);
        ...
        SampoClient.HostingSampo.AuthorizationWithIDshaResponse AuthorizationWithIDsha(SampoClient.HostingSampo.AuthorizationWithIDshaRequest request);
        
        // CODEGEN: Идет формирование контракта на сообщение, так как операция может иметь много возвращаемых значений.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IForOrganizators/AuthorizationWithIDsha", ReplyAction="http://tempuri.org/IForOrganizators/AuthorizationWithIDshaResponse")]
        System.Threading.Tasks.Task<SampoClient.HostingSampo.AuthorizationWithIDshaResponse> AuthorizationWithIDshaAsync(SampoClient.HostingSampo.AuthorizationWithIDshaRequest request);
        ...
        SampoClient.HostingSampo.Partner[] GetPartners(string firstname, string secondname, string patronymic);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IForOrganizators/GetPartners", ReplyAction="http://tempuri.org/IForOrganizators/GetPartnersResponse")]
        System.Threading.Tasks.Task<SampoClient.HostingSampo.Partner[]> GetPartnersAsync(string firstname, string secondname, string patronymic);
        ...
        SampoClient.HostingSampo.Partner[] GetAllPartners(string firstname, string secondname);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IForOrganizators/GetAllPartners", ReplyAction="http://tempuri.org/IForOrganizators/GetAllPartnersResponse")]
        System.Threading.Tasks.Task<SampoClient.HostingSampo.Partner[]> GetAllPartnersAsync(string firstname, string secondname);
        ...
        SampoClient.HostingSampo.Sampo[] GetSampoList(string city);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IForOrganizators/GetSampoList", ReplyAction="http://tempuri.org/IForOrganizators/GetSampoListResponse")]
        System.Threading.Tasks.Task<SampoClient.HostingSampo.Sampo[]> GetSampoListAsync(string city);
        ...
        SampoClient.HostingSampo.Sampo GetSampo(int id);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IForOrganizators/GetSampo", ReplyAction="http://tempuri.org/IForOrganizators/GetSampoResponse")]
        System.Threading.Tasks.Task<SampoClient.HostingSampo.Sampo> GetSampoAsync(int id);
    }
    ...
    public partial class AuthorizationWithLoginResponse {
        ...
        [System.ServiceModel.MessageBodyMemberAttribute(Namespace="http://tempuri.org/", Order=1)]
        public SampoClient.HostingSampo.Partner partner;
        
        public AuthorizationWithLoginResponse() {
        }
        
        public AuthorizationWithLoginResponse(bool AuthorizationWithLoginResult, SampoClient.HostingSampo.Partner partner) {
    ...
    public partial class AuthorizationWithIDshaResponse {
        ...
        public AuthorizationWithIDshaResponse(bool AuthorizationWithIDshaResult, SampoClient.HostingSampo.Partner partner) {
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IForOrganizatorsChannel : SampoClient.HostingSampo.IForOrganizators, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ForOrganizatorsClient : System.ServiceModel.ClientBase<SampoClient.HostingSampo.IForOrganizators>, SampoClient.HostingSampo.IForOrganizators {
        ...
        SampoClient.HostingSampo.AuthorizationWithLoginResponse SampoClient.HostingSampo.IForOrganizators.AuthorizationWithLogin(SampoClient.HostingSampo.AuthorizationWithLoginRequest request) {
            return base.Channel.AuthorizationWithLogin(request);
        }
        
        public bool AuthorizationWithLogin(string login, string password, out SampoClient.HostingSampo.Partner partner) {
            SampoClient.HostingSampo.AuthorizationWithLoginRequest inValue = new SampoClient.HostingSampo.AuthorizationWithLoginRequest();
            inValue.login = login;
            inValue.password = password;
            SampoClient.HostingSampo.AuthorizationWithLoginResponse retVal = ((SampoClient.HostingSampo.IForOrganizators)(this)).AuthorizationWithLogin(inValue);
            partner = retVal.partner;
            return retVal.AuthorizationWithLoginResult;
        }
        
        public System.Threading.Tasks.Task<SampoClient.HostingSampo.AuthorizationWithLoginResponse> AuthorizationWithLoginAsync(SampoClient.HostingSampo.AuthorizationWithLoginRequest request) {
            return base.Channel.AuthorizationWithLoginAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        SampoClient.HostingSampo.AuthorizationWithIDshaResponse SampoClient.HostingSampo.IForOrganizators.AuthorizationWithIDsha(SampoClient.HostingSampo.AuthorizationWithIDshaRequest request) {
            return base.Channel.AuthorizationWithIDsha(request);
        }
        
        public bool AuthorizationWithIDsha(int IDsha, string password, out SampoClient.HostingSampo.Partner partner) {
            SampoClient.HostingSampo.AuthorizationWithIDshaRequest inValue = new SampoClient.HostingSampo.AuthorizationWithIDshaRequest();
            inValue.IDsha = IDsha;
            inValue.password = password;
            SampoClient.HostingSampo.AuthorizationWithIDshaResponse retVal = ((SampoClient.HostingSampo.IForOrganizators)(this)).AuthorizationWithIDsha(inValue);
            partner = retVal.partner;
            return retVal.AuthorizationWithIDshaResult;
        }
        
        public System.Threading.Tasks.Task<SampoClient.HostingSampo.AuthorizationWithIDshaResponse> AuthorizationWithIDshaAsync(SampoClient.HostingSampo.AuthorizationWithIDshaRequest request) {
            return base.Channel.AuthorizationWithIDshaAsync(request);
        }
        
        public SampoClient.HostingSampo.Partner[] GetPartners(string firstname, string secondname, string patronymic) {
            return base.Channel.GetPartners(firstname, secondname, patronymic);
        }
        
        public System.Threading.Tasks.Task<SampoClient.HostingSampo.Partner[]> GetPartnersAsync(string firstname, string secondname, string patronymic) {
            return base.Channel.GetPartnersAsync(firstname, secondname, patronymic);
        }
        
        public SampoClient.HostingSampo.Partner[] GetAllPartners(string firstname, string secondname) {
            return base.Channel.GetAllPartners(firstname, secondname);
        }
        
        public System.Threading.Tasks.Task<SampoClient.HostingSampo.Partner[]> GetAllPartnersAsync(string firstname, string secondname) {
            return base.Channel.GetAllPartnersAsync(firstname, secondname);
        }
        
        public SampoClient.HostingSampo.Sampo[] GetSampoList(string city) {
            return base.Channel.GetSampoList(city);
        }
        
        public System.Threading.Tasks.Task<SampoClient.HostingSampo.Sampo[]> GetSampoListAsync(string city) {
            return base.Channel.GetSampoListAsync(city);
        }
        
        public SampoClient.HostingSampo.Sampo GetSampo(int id) {
            return base.Channel.GetSampo(id);
        }
        
        public System.Threading.Tasks.Task<SampoClient.HostingSampo.Sampo> GetSampoAsync(int id) {
